		...
		if (result===405){return matrix;}
			...
			if (result===405){return matrix;}
				...
				if (result===405){return matrix;}
					...
					findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares(); findNumbers_A(); findNumbers();	findInSubsquares();	findNumbers();	findNumbers_D();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();
					...
					if (result===405){return matrix;}	
						...
						findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers_D(); findNumbers();	findInSubsquares();	findNumbers();	findNumbers_D();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers_D(); findNumbers_A();	findNumbers();	findInSubsquares();	findNumbers_A(); findNumbers();	findNumbers_D(); findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();	findInSubsquares();	findNumbers();
